...
def builderInitIPv4ReassemblyBuffer(c_builder: CBuilderPtr) -> CBuilderPtr:
	return _builderInitIPv4ReassemblyBuffer(c_builder)

builderInitIPv4FragmentsCache = builderInitIPv4ReassemblyBuffer

try:
	_builderInitIPv4ReassemblyBuffer = atffs(builderInitIPv4FragmentsCache, lib)
except AttributeError:
	builderInitIPv4ReassemblyBuffer.__name__ = "builderInitIPv4FragmentsCache"
